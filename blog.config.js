...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '25f9f1f8a0b64fd1b11f2a19d44ae1f2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '韩菲羽', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '有了你以后梦到的世界都是彩色的。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://closertoyou.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '我的刺猬女孩,剧集,照片', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '我的刺猬女孩', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '韩菲的天空', // 站点描述，被notion中的页面描述覆盖
